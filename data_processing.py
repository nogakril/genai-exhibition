...
def vlookup_description(input_file, lookup_file, output_file):
    data = pd.read_csv(input_file)
    lookup_data = pd.read_csv(lookup_file)
    data['Description'] = data['Object ID'].map(lookup_data.set_index('Object ID')['Description'])
    data = data[data['hasImage'] == True]
    data.to_csv(output_file, index=False)


if __name__ == '__main__':
    vlookup_description('/Users/noga.kril/PycharmProjects/genAiExhibition/MetObjects_w_hasImage.csv',
                        '/Users/noga.kril/PycharmProjects/genAiExhibition/objects_w_images_thin_w_description.csv',
                        '/Users/noga.kril/PycharmProjects/genAiExhibition/MetObjects_w_hasImageTrue_w_description.csv')
